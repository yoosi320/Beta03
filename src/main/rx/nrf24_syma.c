...
static void symaNrf24Setup(rx_spi_protocol_e protocol)
{
    ...
    */    //yoosi 200709
    if (symaProtocol == RX_SPI_NRF24_SYMA_X) {
        ...
        // NRF24L01_WriteReg(NRF24L01_06_RF_SETUP, NRF24L01_06_RF_SETUP_RF_DR_250Kbps | NRF24L01_06_RF_SETUP_RF_PWR_n12dbm);   //yoosi200709
        protocolState = STATE_BIND;
        // RX_ADDR for pipes P1-P5 are left at default values
        //NRF24L01_WriteRegisterMulti(NRF24L01_0A_RX_ADDR_P0, rxTxAddr, RX_TX_ADDR_LEN);    //yoosi 200709
    } else {
    ...
    NRF24L01_WriteData(0x53,0x5a);
    NRF24L01_WriteData(0x53,0xa5);
    NRF24L01_WriteData(0xfc,0x00);
    NRF24L01_WriteData(0xe1,0x00);
    NRF24L01_WriteData(0xe2,0x00);
    NRF24L01_WriteData(0x27,0x70);
    NRF24L01_WriteData(0x22,0x01);
    NRF24L01_WriteData(0x23,0x03);
    NRF24L01_WriteData(0x25,0x33);
    NRF24L01_WriteData(0x31,0x0A);
    NRF24L01_WriteData(0x3C,0x00);
    NRF24L01_WriteData(0x3D,0x20);
    NRF24L01_WriteData(0x26,0xD5);
    NRF24L01_WriteData(0x24,0x00);
    NRF24L01_WriteData(0x21,0x00);
    NRF24L01_WriteData(0xFC,0x00);
    NRF24L01_WriteData(0x20,0x8F);
	delayMicroseconds(15);
	NRF24L01_WriteData(0xFD,0x00);
	...
	NRF24L01_ReadReg(0x05);
	NRF24L01_ReadReg(0x06);	
