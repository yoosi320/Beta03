...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM3, IO_TAG(PA6), TIM_Channel_1, TIM_USE_MOTOR,   0 }, // PWM5 - RC5
    { TIM3, IO_TAG(PA7), TIM_Channel_2, TIM_USE_MOTOR,   0 }, // PWM6 - RC6
    { TIM3, IO_TAG(PB0), TIM_Channel_3, TIM_USE_MOTOR,   0 }, // PWM7 - RC7
    { TIM3, IO_TAG(PB1), TIM_Channel_4, TIM_USE_MOTOR,   0 }, // PWM8 - RC8
    /*
