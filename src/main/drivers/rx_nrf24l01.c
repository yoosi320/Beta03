...
//#define NRF24_CE_HI()   {IOHi(DEFIO_IO(RX_CE_PIN));}   //yoosi320 200709
//#define NRF24_CE_LO()   {IOLo(DEFIO_IO(RX_CE_PIN));}   //yoosi320 200709
...
#define CE_FSPI_ON    0xFD  //yoosi
#define CE_FSPI_OFF   0xFC  //yoosi


static void NRF24L01_InitGpio(void)
{
    // CE as OUTPUT
    // 주석처리 //yoosi320 200709
    ...
    */   //yoosi320 200709
    ...
    NRF24_CE_HI(); //yoosi 200709
}

//yoosi 함수추가
void NRF24L01_WriteData(uint8_t reg, uint8_t data)
{
    rxSpiWriteCommand(reg, data);
}
/*
 * Soft CE Control
 * YOOSI  191204
...
void NRF24_CE_LO(void){
	rxSpiWriteCommand(CE_FSPI_OFF ,0);
}
void NRF24_CE_HI(void){
	rxSpiWriteCommand(CE_FSPI_ON ,0);
}
...
void NRF24L01_Initialize(uint8_t baseConfig)
{
    ...
    NRF24L01_Activate(0x73);  //yoosi 200709
}
